...
async function main() {
  ...
  // Deploy API3PriceFeed (production-ready)
  console.log("\nDeploying API3PriceFeed...");
  ...
  console.log("API3PriceFeed deployed to:", priceFeedAddress);
  
  // Configure for testing environment (shorter staleness period)
  console.log("Configuring API3PriceFeed for testing...");
  await priceFeed.setMaxPriceAge(1 * 60 * 60); // 1 hour instead of 24 hours
  
  // Update prices to ensure they're fresh for testing
  console.log("Updating prices to current timestamp...");
  ...
  console.log("Prices updated and configured for testing");
  ...
  // Set StakeBasket contract in StakeBasketToken (using emergency function for testing)
